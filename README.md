...
In the Macros folder, you will find two folders (one for analysis of data and one for simulation). /n
a) Analysis
...
5. anode_cathode_coincidence.cpp validates all fission anode signals by imposing restricting criteria for cathode signals. /n
b) Simulation
